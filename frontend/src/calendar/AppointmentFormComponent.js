...
class AppointmentFormComponent extends React.Component {
  ...
  render() {
    ...
    const textEditorProps = field => ({
      variant: 'outlined',
      onChange: ({ target }) =>
        this.changeAppointment({ field: [field], changes: target.value }),
    ...
    const pickerEditorProps = field => ({
      ...
      onChange: date =>
        this.changeAppointment({
          field: [field],
          changes: date.format('YYYY-MM-DD HH:mm')
        }),
      variant: 'outlined',
        ...
        <AppointmentForm.Container className={classes.container}>
          ...
          <div className={classes.content}>
            <div className={classes.wrapper}>
              <TextField label="Nazwa" {...textEditorProps('title')} />
            </div>
            <div className={classes.wrapper}>
          ...
          <div className={classes.pathSelectorWithButtons}>
            ...
            <div className={classes.buttonGroup}>
              ...
              <Button
                ...
                color="primary"
                disabled={
                  displayAppointmentData.startDate >
                    displayAppointmentData.endDate ||
...
export default connect(mapStateToProps)(
  withStyles(containerStyles)(AppointmentFormComponent)
);
