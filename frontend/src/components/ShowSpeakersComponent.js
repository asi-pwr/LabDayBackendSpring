...
class ShowSpeakersComponent extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (
      speakerReducer.deletedItemId !== prevProps.speakerReducer.deletedItemId
    ) {
      dispatch(
        restActions.restGet('/speakers', restConstants.GET_SPEAKER_REQUEST)
      );
  ...
  return (
    <Card className={classes.card}>
      ...
      <CardContent>
        ...
        <Typography component="p">info: {speaker.info}</Typography>
      </CardContent>
      <CardActions className={classes.cardAction}>
        <Button
          ...
          onClick={() => {
            dispatch(
              restActions.restDelete(
                speaker.id,
                '/speakers',
                restConstants.DELETE_SPEAKER_REQUEST
              )
            );
          }}
        >
        ...
        <Button disabled className={classes.buttonId}>
          id: {speaker.id}
        </Button>
      </CardActions>
    </Card>
...
export default connect(mapStateToProps)(
  withStyles(styles)(ShowSpeakersComponent)
);
