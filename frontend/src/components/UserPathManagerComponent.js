...
class UserPathManagerComponent extends Component {
  ...
  pathChange(pathId, userId) {
    ...
    dispatch(
      restActions.restPost(user, '/users', restConstants.POST_USER_REQUEST)
    );
  }
    ...
    return (
      <Card className={classes.card}>
        <CardContent>
          ...
          <br />
          Publiczny dostep:
          <Switch checked={publicAccess} onChange={publicAccessChange} />
        </CardContent>
      </Card>
    );
  }
...
export default connect(mapStateToProps)(
  withStyles(styles)(UserPathManagerComponent)
);
